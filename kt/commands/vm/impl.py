...
CLOUD_INIT_BASE_PATH = Path(__file__).parent.parent.parent.joinpath("data/cloud_init.yaml")
...
class VmInstance:
    ...
    def expected_kernel_version(self):
        kernel_version = SshCommand.running_kernel_version(domain=self.domain)
